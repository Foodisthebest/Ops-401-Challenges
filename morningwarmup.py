warning_file = 'warnings.log'  # File for warning log entries
error_file = 'errors.log'      # File for error log entries
threat_file = 'threats.log'    # File for threat log entries
log_entries = [
    "[2024-02-01 08:30:15] WARNING: Unauthorized access attempt detected from IP address 192.168.1.100.",
...
# Function to categorize log entries and append them to respective files
def categorize_and_append_log(entry):
    if 'WARNING' in entry:
        ...
        with open(threat_file, 'a') as file:
            file.write(entry + '\n')
# Iterate over log entries and append them to respective files
for entry in log_entries:
    categorize_and_append_log(entry)